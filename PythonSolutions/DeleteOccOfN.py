...
of the places they've been, and now they want to show Charlie their entire collection. 
However, Charlie doesn't like these sessions, since the motif usually repeats. He isn't 
...
def delete_nth(order, max_e):
    ...
    for nums in order:
        ...
        elif new_list.count(nums) < max_e:
            new_list.append(nums)
    return new_list
